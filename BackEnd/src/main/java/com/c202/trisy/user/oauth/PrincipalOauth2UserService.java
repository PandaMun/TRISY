package com.c202.trisy.user.oauth;
...
import com.c202.trisy.user.oauth.provider.GoogleUserInfo;
import com.c202.trisy.user.oauth.provider.OAuth2UserInfo;
